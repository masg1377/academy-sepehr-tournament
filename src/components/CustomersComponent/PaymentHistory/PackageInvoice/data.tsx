...
export const columns: any = [
  ...
  },
  {
    name: "Last Update",
    minWidth: "180px",
    sortable: (row: any) => row.status_transitions_finalized_at,
    selector: (row: any) => row.status_transitions_finalized_at,
    cell: (row: any) => {
      return (
        <div className="d-flex">
          {getCustomDate(row.status_transitions_finalized_at)}
        </div>
      );
    },
  },
