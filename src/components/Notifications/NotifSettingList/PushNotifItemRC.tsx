...
const PushNotifItemRC = () => {
  ...
  return (
    ...
    >
      <SwitchBox name="push-notif-item" />
      <Tooltip
        style={{
          backgroundColor: "#fff",
          color: "#2e2e33",
        ...
        placement="top"
        isOpen={tooltipOpen}
        target="PushNotifExample"
        toggle={toggle}
      >
        Read only
      </Tooltip>
      <Eye size={17} id="PushNotifExample" className="cursor-pointer" />
      <Clock size={15} className="ms-1" />
    </FormWrapper>
  );
};

export default PushNotifItemRC;
