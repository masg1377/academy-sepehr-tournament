      ...
      return (
        <div className="d-flex align-items-start">
          ...
          <div>
            ...
            <div>
              <span className="fs-7 fw-bold lh-base text-primary">
                Paid By:{" "}
              </span>
              <span className="fs-7 lh-base text-secondary ">{row.paidBy}</span>
            </div>
            <div>
    ...
    cell: (row: any) => {
      return (
        <div className="d-flex flex-column align-items-end justify-content-between h-100">
          ...
          <span className="fs-8 text-secondary">{row.date}</span>
        </div>
      );
    },
  },
