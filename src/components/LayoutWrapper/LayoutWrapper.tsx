// ** React Imports
import { Fragment, useEffect, memo, FC } from "react";
...
interface ILayoutWrapperProp {
  children: any;
  routeMeta?: any;
}

const LayoutWrapper: FC<ILayoutWrapperProp> = memo(
  ({ children, routeMeta }): JSX.Element => {
    // ** Props
    ...
    const navbarStore: any = store.navbar;
