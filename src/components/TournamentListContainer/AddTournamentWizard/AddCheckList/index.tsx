...
const AddCheckList: FC<IAddMlsConfigProp> = ({
  stepper,
  type,
}): JSX.Element => {
  const { id } = useParams();
  ...
  const onLoadData = () => {
    getListOfTournamentCheckList.mutate(tournamentId, {
      onSuccess: (res) => {
                  ...
                  <SelectOption
                    ...
                    onChange={(opt) => {
                      ...
                      if (opt) {
                        ...
                        getListOfTournamentCheckList.mutate(opt?.value, {
                          onSuccess: (res) => {
                            const result = res.data;
                            console.log(result);
                            setData(
