...
const Customizer: FC<any> = (props): JSX.Element => {
  // ** Props
  const {
    skin,
    isRtl,
  ...
  const renderSkinsRadio = (): JSX.Element[] => {
    const skinsArr: {
      name: string;
      label: string;
      checked: boolean;
  ...
  const renderNavbarColors = (): JSX.Element[] => {
  ...
  const renderNavbarTypeRadio = (): JSX.Element[] => {
    const navbarTypeArr: {
      name: string;
      label: string;
      checked: boolean;
  ...
  const renderFooterTypeRadio = (): JSX.Element[] => {
    const footerTypeArr: {
      name: string;
      label: string;
      checked: boolean;
