...
interface IListTablePaginateProp {
  data: any;
...
const ListTablePaginate: FC<IListTablePaginateProp> = ({
  data,
  headerTitle,
  columns,
  addBtnText,
    ...
    >
      ...
      {!props.noPagination && (
        <ReactPaginate
          ...
          pageCount={totalCount ? Math.ceil(totalCount / limit) : 1}
          breakLabel="..."
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(
          "react-dataTable-paginate",
          selectebaleRows && "react-dataTable-selectable-rows",
          totalCount > limit && "react-dataTable-paginate-padding"
        )}
      >
        {isLoading ? (
          <LoadingData />
      ...
      {totalCount > limit && <CustomPagination />}
    </Card>
  );
};
